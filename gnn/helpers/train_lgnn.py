...
https://github.com/dmlc/dgl/blob/master/examples/pytorch/line_graph/train.py
...
parser.add_argument('--n-communities', type=int, help='Number of communities', default=20)
...
parser.add_argument('--n-graphs', type=int, help='Number of graphs', default=1)
parser.add_argument('--n-layers', type=int, help='Number of layers', default=30)
parser.add_argument('--n-nodes', type=int, help='Number of nodes', default=3500)
...
model = LGNN(feats, args.radius, K).to(dev)
...
th.save
# model.eval() when loading for inference